...
private:
    void testConstructor() {
        ...
        Employee employee("John Doe", 101, 30, true, "Developer", FullTime, 60000.0);
    ...
    void testCalculateTotalPayment_FullTime() {
        cout << "\nTesting Total Payment Calculation for Full-Time Employee..." << endl;

        Employee employee("Jane Smith", 102, 28, true, "Manager", FullTime, 80000.0);
        ...
        if (calculatedPayment != expectedPayment) {
            ...
            cout << "Expected: $" << expectedPayment << ", Calculated: $" << calculatedPayment << endl;
        } else {
    ...
    void testCalculateTotalPayment_PartTime() {
        cout << "\nTesting Total Payment Calculation for Part-Time Employee..." << endl;
