...
Employee::Employee(const std::string &name, int employeeID, int age,
                   bool isActive, std::string position, WorkType workType,
                   float payRate, int hoursWorked)
...
// Getter for workType
WorkType Employee::getWorkType() const { return workType; }
