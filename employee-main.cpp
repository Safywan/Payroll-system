...
int main()
{
    ...
    {
        cout << "No save file detected. Please ask your manager to create and save a payroll" << endl;
        return 0;
    }
    ...
    do // Iterate over all the options until the user exits the program
    {
        ...
        case 2: // set num_hours
            ...
            break;
        case 3:
            cout << "This cycle you will be paid: $" << employee_ptr->calculateTotalPayment() << endl;
            break;
        case 4:
